...
public class Manager<Value> implements Map<String, Value> {
    ...
    @Setter @Getter private ManagerHandler<Value> handler = new ManagerHandler<Value>() {};
    ...
    public void loadSingle(String key) {
        put(key, loadObject(storage.get(key)));
    }
    ...
    public Value remove(Object key) {
        ...
        Value obj = loadedObjects.remove(key);
        if(obj != null)
            handler.objectRemoved(obj);
